  ...
  const addWatermark = async () => {
    try {
      ...
      const response = await axios.post(
        `${API_BASE_URL}/jpg-api/watermark`,
        formData,
        {
          responseType: "blob",
        },
    ...
    <main className="min-h-screen bg-[#070B17] text-white">
      <div className="max-w-4xl mx-auto px-6 py-14">
        ...
        <div className="text-center">
          ...
          <h1 className="text-5xl font-black">Watermark PDF</h1>

          <p className="mt-4 text-gray-400 text-lg">
            Add text watermark to every PDF page.
          </p>
        </div>
        ...
        <div className="mt-12 rounded-[32px] border border-white/10 bg-[#101827] p-8">
          ...
          <div className="mt-6">
            ...
            <input
              ...
              className="w-full h-14 rounded-2xl bg-[#0F172A] border border-white/10 px-5 outline-none focus:border-cyan-500"
            />
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full mt-8 h-14 rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-500 font-semibold text-lg hover:opacity-90 transition disabled:opacity-50"
          >
